    ...
    <main className="test-page">
      <div className="test-card">
        ...
        <section className="test-section">
          ...
          <div className="type-grid">
            <button className={`type-card ${bookingType === "room" ? "selected" : ""}`} onClick={() => setBookingType("room")}>
              <div className="type-icon">▐</div><div><strong>1 ห้อง</strong><small>฿{ROOM_PRICE.toLocaleString()}/คืน</small></div>{bookingType === "room" && <em>✓</em>}
            </button>
            <button className={`type-card ${bookingType === "house" ? "selected" : ""}`} onClick={() => setBookingType("house")}>
              <div className="type-icon">⌂</div><div><strong>เหมาหลัง</strong><small>฿{HOUSE_PRICE.toLocaleString()}/คืน</small></div>{bookingType === "house" && <em>✓</em>}
            </button>
          </div>
        </section>
        ...
        <section className="test-section">
          ...
          <Counter label="ผู้ใหญ่" hint="อย่างน้อย 1 คน" value={adults} onMinus={() => changeAdults(-1)} onPlus={() => changeAdults(1)} />
          <Counter label="เด็ก" hint="ไม่เกิน 12 ปี" value={children} onMinus={() => changeChildren(-1)} onPlus={() => changeChildren(1)} />
...
function Counter({label,hint,value,onMinus,onPlus}) {
  return <div className="counter"><div className="counter-title"><span className="person-icon">●</span><div><strong>{label}</strong><small>{hint}</small></div></div><div className="counter-control"><button onClick={onMinus}>−</button><span>{value}</span><button onClick={onPlus}>＋</button></div></div>;
}
