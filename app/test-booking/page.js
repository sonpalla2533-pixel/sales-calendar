...
function PersonIcon({ child = false }) {
  return (
    <svg className="line-icon" viewBox="0 0 48 48" aria-hidden="true">
      <circle cx="24" cy={child ? "13" : "11"} r={child ? "5" : "5.5"} />
      <path d={child ? "M16 35c0-5 3.5-8 8-8s8 3 8 8v3H16z" : "M15 39c0-6 3.5-10 9-10s9 4 9 10"} />
    </svg>
  );
}
